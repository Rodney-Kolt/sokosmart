 ...
 * Step 4b: vendor category → business details → register vendor.
 * Two sub-steps: "category" and "details".
 */
      ...
      <div className="w-full max-w-sm">
        ...
        <div className="space-y-3">
          <div>
            ...
            <input id="biz-name" className={inputCls} placeholder="Business name" value={bizName}
              onChange={(e) => { setBizName(e.target.value); setError(""); }} autoFocus />
          </div>
          ...
          <button onClick={requestLocation} disabled={locStatus === "loading"}
            ...
            📍 {locStatus === "idle"    && "Add my location (optional)"}
                ...
                {locStatus === "error"   && "⚠️ Couldn't get location — try again"}
          </button>
